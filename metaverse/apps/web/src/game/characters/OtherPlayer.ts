...
import { PlayerUpdatePayload } from "@repo/common/game";
...
export default class OtherPlayer extends Player {
  ...
  updateOtherPlayer(payload: PlayerUpdatePayload) {
    if (this.playerId !== payload.userId) return;
    this.targetPosition[0] = payload.position.x;
    this.targetPosition[1] = payload.position.y;
    this.anims.play(payload.anim, true);
